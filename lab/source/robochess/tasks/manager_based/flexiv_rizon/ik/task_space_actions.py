...
from .differential_ik import FlexivRizonDifferentialIKController
from .differential_ik_cfg import FlexivRizonDifferentialIKControllerCfg

class FlexivRizonDifferentialInverseKinematicsAction(ActionTerm):
    ...
    cfg: FlexivRizonDifferentialInverseKinematicsActionCfg
    ...
    def __init__(self, cfg: FlexivRizonDifferentialInverseKinematicsActionCfg, env: ManagerBasedEnv):
        ...
        self._ik_controller = FlexivRizonDifferentialIKController(
...
@configclass
class FlexivRizonDifferentialInverseKinematicsActionCfg(ActionTermCfg):
    """Configuration for inverse differential kinematics action term.

    See :class:`FlexivRizonDifferentialInverseKinematicsAction` for more details.
    """
    ...
    class_type: type[ActionTerm] = FlexivRizonDifferentialInverseKinematicsAction
    ...
    controller: FlexivRizonDifferentialIKControllerCfg = MISSING
