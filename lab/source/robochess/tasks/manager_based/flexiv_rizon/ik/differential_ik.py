...
class FlexivRizonDifferentialIKController:
    ...
    def __init__(self, cfg: FlexivRizonDifferentialIKControllerCfg, num_envs: int, device: str):
    ...
    def compute(
        ...
        """
        joint_weights = self.cfg.joint_weights.to(self._device)
        if joint_weights is not None:
            scale = joint_weights.float().pow(-0.5)  # (num_joints,)
